...
{
    private final int FRAME_WIDTH = 800;  //frame width
    private final int FRAME_HEIGHT = 800;  //frame height
...
{
    private final int PANEL_WIDTH = 800;  //panel width
    private final int PANEL_HEIGHT = 800;  //panel height
...
//                        if (xRec[i] + RW + xMoveBy[i] > xRec[j]
//                                && xRec[i] + xMoveBy[i] < xRec[j] + RW
//                                && yRec[i] + RH > yRec[j]
//                                && yRec[i] < yRec[j] + RH) {
//                            xMoveBy[i] *= -1;
//                        } //bounce off left and right edges of screen
//                        else if (xRec[i] < 0 || xRec[i] + RW > PANEL_WIDTH) {
//                            xMoveBy[i] *= -1;
//                        }
//
...
//                        if (xRec[i] + RW > xRec[j]
//                                && xRec[i] < xRec[j] + RW
//                                && yRec[i] + RH + yMoveBy[i] > yRec[j]
//                                && yRec[i] + yMoveBy[i] < yRec[j] + RH) {
//                            yMoveBy[i] *= -1;
//                        } //bounce off top and bottom edges of screen
//                        else if (yRec[i] < 0 || yRec[i] + RH > PANEL_HEIGHT) {
//                            yMoveBy[i] *= -1;
//                        }
//                    }
                }
